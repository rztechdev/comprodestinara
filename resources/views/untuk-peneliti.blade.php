...
@section('title', 'Untuk Peneliti & Akademisi — Riset Lapangan Kredibel, Kliring Etik & Akses Data | Destinara')
@section('meta_description', 'Layanan fasilitasi riset lapangan, protokol persetujuan etik FPIC masyarakat adat, logistik ekspedisi ilmiah, dan pendampingan antropologi terapan di Nusantara.')
              ...
              <div class="rgs-card-alt group flex flex-col sm:flex-row gap-space-md sm:gap-space-lg items-start pt-5 pb-5">
                ...
                <div class="flex flex-col gap-space-xs">
                  <div class="flex flex-wrap items-center gap-space-xs sm:gap-space-sm">
                    ...
                    <span class="bg-surface-container text-secondary text-[12px] px-2 py-0.5 rounded-none font-medium border border-outline-variant/30">Primer</span>
                  </div>
              ...
              <div class="rgs-card-alt group flex flex-col sm:flex-row gap-space-md sm:gap-space-lg items-start pt-5 pb-5">
                ...
                <div class="flex flex-col gap-space-xs">
                  <div class="flex flex-wrap items-center gap-space-xs sm:gap-space-sm">
                    ...
                    <span class="bg-surface-container text-secondary text-[12px] px-2 py-0.5 rounded-none font-medium border border-outline-variant/30">Birokrasi</span>
                  </div>
                  <p class="font-body-default text-sm sm:text-body-default text-on-surface-variant">
              ...
              <div class="rgs-card-alt group flex flex-col sm:flex-row gap-space-md sm:gap-space-lg items-start pt-5 pb-5">
                ...
                <div class="flex flex-col gap-space-xs">
                  <div class="flex flex-wrap items-center gap-space-xs sm:gap-space-sm">
                    ...
                    <span class="bg-surface-container text-secondary text-[12px] px-2 py-0.5 rounded-none font-medium border border-outline-variant/30">Etika</span>
                  </div>
                  <p class="font-body-default text-sm sm:text-body-default text-on-surface-variant">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-space-xl rgs-grid-connected-alt">
            ...
            <div class="rgs-card-alt group flex flex-col gap-space-sm h-full pt-4 pb-4">
              <div class="flex items-center justify-between">
                ...
                <span class="font-caption-fieldnote text-caption-fieldnote text-secondary italic">Pasca-Riset</span>
              </div>
              <h3 class="font-headline-sm text-headline-sm text-on-surface pt-space-xs">
        ...
        <div class="max-w-[1280px] mx-auto px-gutter-mobile md:px-gutter-desktop">
          <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-space-lg mb-space-2xl">
            ...
            <div class="flex flex-wrap items-center gap-space-sm">
              ...
              <span class="bg-surface px-space-sm py-space-2xs rounded-none border border-outline-variant/30 text-[13px] text-secondary font-medium shadow-none">Akomodasi</span>
              <span class="bg-surface px-space-sm py-space-2xs rounded-none border border-outline-variant/30 text-[13px] text-secondary font-medium shadow-none">Logistik Makan</span>
              <span class="bg-surface px-space-sm py-space-2xs rounded-none border border-outline-variant/30 text-[13px] text-secondary font-medium shadow-none">Narasumber Adat</span>
            </div>
          </div>
              ...
              <div class="lg:col-span-6 bg-surface-container-low p-space-lg sm:p-space-xl rounded-none border border-outline-variant/30">
                <form class="flex flex-col gap-space-md" onsubmit="event.preventDefault(); showToast('Rencana riset diterima. Tim kurator akademik Destinara akan menghubungi via email dalam 24 jam.', 'success'); this.reset();">
                  <div>
                    ...
                    <input class="w-full bg-surface text-on-surface px-space-md py-space-sm rounded-none border border-outline-variant/40 font-body-sm text-body-sm outline-none focus:border-primary shadow-none" id="nama-peneliti" placeholder="cth. Dr. Nurul Hidayah, M.A." required="" type="text"/>
                  </div>
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
                    <div>
                      ...
                      <input class="w-full bg-surface text-on-surface px-space-md py-space-sm rounded-none border border-outline-variant/40 font-body-sm text-body-sm outline-none focus:border-primary shadow-none" id="institusi-kampus" placeholder="cth. Universitas Gadjah Mada" required="" type="text"/>
                    </div>
                    <div>
