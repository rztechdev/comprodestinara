...
class TeamMemberSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $members = [
            ...
            [
                'name' => 'Azki',
                'role' => 'Riset Lapangan & Kerjasama Akademik',
                'affiliation' => 'Fasilitator Riset Komunitas & Penyelaras FPIC',
                'bio' => "Mendampingi sivitas akademika, peneliti independen, dan lembaga riset dalam mengurus perizinan Kesbangpol, kliring etik komunitas adat (FPIC), dan logistik stasiun riset lapangan.\n\nMemastikan transmisi data primer dan naskah tradisi lisan diarsipkan secara bermartabat dan resiprokal bersama warga tapak.",
                'location' => 'Sekretariat Sleman & Yogyakarta Kota',
                'email' => 'azki@destinara.id',
                'phone' => '+62 858-9486-0696',
                'photo' => 'assets/img/hd/team-azki.jpg',
                'linkedin' => 'https://linkedin.com',
                'instagram' => 'https://instagram.com',
                'order' => 3,
                'is_active' => true,
